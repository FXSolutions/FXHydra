...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Hydra/M13ProgressSuite.framework"
  ...
  install_framework "Pods-Hydra/StreamingKit.framework"
  install_framework "Pods-Hydra/TinySQLite.framework"
  install_framework "Pods-Hydra/Toucan.framework"
  install_framework "Pods-Hydra/VK_ios_sdk.framework"
  install_framework "Pods-Hydra/XCGLogger.framework"
  install_framework "Pods-Hydra/YYKit.framework"
